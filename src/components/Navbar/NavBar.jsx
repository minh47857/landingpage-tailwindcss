    ...
    return (
        <nav className="flex items-center">
            <div className="flex items-center">
                ...
                {!isDarkMode ?
                    <BsSunFill size={"24px"} color="#e9c463" className="cursor-pointer" onClick={() => toggleDarkMode(!isDarkMode)} />
                    :
                    <FaMoon size={"24px"} color="#e9c463" className="cursor-pointer" onClick={() => toggleDarkMode(!isDarkMode)} />
                }
            </div>
